  ...
  return (
    <div className="navigation d-flex justify-content-center align-items-center">
      <svg className="navigation-animatable flip-x" height="20" viewBox="0 0 655 244" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path id="curly-nav2" className="curly-nav dash-in" d="M0.999998 144.5C0.999998 144.5 -8.5 144.5 140 144.5C288.5 144.5 404.5 232 479.5 240.5C554.5 249 658.5 238 654 144.5C649.5 50.9999 519 0.499705 479.5 0.499756C440 0.499807 423.738 12.8773 432.5 42.5C441.262 72.1226 549 101 520.5 42.5" stroke="black" />
      </svg>
      <ul className="nav">
      ...
      <svg className="navigation-animatable" height="20" viewBox="0 0 655 244" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path id="curly-nav1" className="curly-nav dash-in" d="M0.999998 144.5C0.999998 144.5 -8.5 144.5 140 144.5C288.5 144.5 404.5 232 479.5 240.5C554.5 249 658.5 238 654 144.5C649.5 50.9999 519 0.499705 479.5 0.499756C440 0.499807 423.738 12.8773 432.5 42.5C441.262 72.1226 549 101 520.5 42.5" stroke="black" />
      </svg>
    </div>
  );
}
